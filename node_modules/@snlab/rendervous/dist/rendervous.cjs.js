...
function polarGeometry (geometry, context, _transformations, settings = {}) {
  ...
  const toTheta = d3Scale.scaleLinear().domain(context.rangeX).range([0, 2 * Math.PI]);
  const toRadius = d3Scale.scaleLinear().domain(context.rangeY).range([0, 1]);
...
exports.polarGeometry = polarGeometry;
